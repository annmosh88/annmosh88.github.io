      ...
      <section id="work" className="work">
        <div className="s-inner">
          ...
          <div className="work-list">
            {[
              { num: '01', title: 'KSUCU-MC Website', desc: 'The official full-stack web platform for Kisii University Christian Union — featuring authentication, content management, and community tools serving a large student organization on campus.', cats: ['Full Stack','Laravel'], collab: 'Live · Team Project', link: 'https://ksucu-mc.co.ke' },
            ].map((p, i) => (
